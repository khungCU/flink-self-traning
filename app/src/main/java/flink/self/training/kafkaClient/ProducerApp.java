package flink.self.training.kafkaClient;
...
import com.flink.self.training.Event;
...
public class ProducerApp {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final Properties props = new Properties() {{
            ...
            put(VALUE_SERIALIZER_CLASS_CONFIG, KafkaJsonSerializer.class.getCanonicalName());
            put(ACKS_CONFIG,                   "all");
        }};
